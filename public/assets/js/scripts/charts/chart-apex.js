...
$(document).ready(function () {
  ...
  var pekerjaanChartOptions = {
    ...
    xaxis: {
      categories: ['Pelajar/Mahasiswa', 'Pegawai Swasta', 'Dokter'],
    },
    yaxis: {
      title: {
        text: 'Jumlah'
  ...
  var pekerjaanChart = new ApexCharts(
    document.querySelector("#pekerjaan-chart"),
    pekerjaanChartOptions
  );
  ...
  var jkChart = new ApexCharts(
    document.querySelector("#jenis-kelamin-chart"),
    jkChartOptions
  );
  ...
  var pkChart = new ApexCharts(
    document.querySelector("#pendidikan-terakhir-chart"),
    pkChartOptions
  );
  ...
  var tahunChartOptions = {
    ...
    xaxis: {
      categories: ['Kanak-kanak (5-11 tahun)', 'Remaja (12-25 tahun)', 'Dewasa (26-45 tahun)', 'Lansia (46-65 tahun)'],
    },
    yaxis: {
      title: {
        text: 'Jumlah'
  ...
  var usiaChart = new ApexCharts(
    document.querySelector("#golongan-usia-chart"),
    usiaChartOptions
  );
