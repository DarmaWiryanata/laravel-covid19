            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ $item['pendidikan_terakhir'] }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <div>
                                <canvas id="pendidikan-terakhir-chart-{{ $loop->index }}" height="250"></canvas>
                            </div>
                            <div>
...
@section('js')
    ...
    <script>
        ...
        async function chart() {
            const response = await fetch('http://localhost:8000/api/pendidikan-terakhir')
            ...
            for (item of data) {
                ...
                var barChartctx = $("#pendidikan-terakhir-chart-"+i);
