            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ $item['jenis_kelamin'] }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <div>
                                <canvas id="jenis-kelamin-chart-{{ $loop->index }}" height="250"></canvas>
                            </div>
                            <div>
    ...
    <script>
        $(window).on("load", function () {
            ...
            async function chart() {
                const response = await fetch('http://localhost:8000/api/jenis-kelamin')
                ...
                for (item of data) {
                    ...
                    // Jumlah Pengetahuan Chart
                    // ------------------------------------------
    
                    //Get the context of the Chart canvas element we want to select
                    var barChartctx = $("#jenis-kelamin-chart-"+i);
